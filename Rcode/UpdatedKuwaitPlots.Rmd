...
polarCluster(KuwaitFullJoin, pollutant="RawConc", 
                        n.clusters = 5, main = "Polar Plot of Hourly PM (2017-2020) with Wind Speed and Direction Clustered", cols= c("#66c2a5","#fc8d62","#8da0cb","#e78ac3","#a6d854"))

timeVariation(results6, pollutant = "RawConc", group = "cluster",
              key.columns = 3,
             ci = FALSE, main = "Diuranal Cylces for Unfiltered PM values With Clusters 1-3", xlab= "Cluster", ylab = "(UG/M3)", cols= c("#66c2a5","#fc8d62","#8da0cb"))

timeVariation(results5, pollutant = "RawConc", group = "cluster",
              key.columns = 4,
             ci = FALSE, main = "Diuranal Cylces for Unfiltered PM values With Clusters 1-4", xlab= "Cluster", ylab = "(UG/M3)", cols= c("#66c2a5","#fc8d62","#8da0cb","#e78ac3"))


 timePlot(filter(KuwaitFullJoin, Year == 2020, visibility >= 4, RawConc <= 200),
         pollutant = c("RawConc")
